...
class MyClient(discord.Client):
    ...
    async def my_background_task(self):
        channel = self.get_channel(1171087824678821959)  # ID do canal onde a msg será enviada ID do canal: 1161828992102432808
        ...
        if self.raid_atual != obtem_info_goons[0] or self.horario_atual != obtem_info_goons[2]:
            ...
            print(f'{datetime.now()} - {self.raid_atual} - {self.data_atual} - {self.horario_atual}')
